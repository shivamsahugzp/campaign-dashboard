#!/usr/bin/env python3
"""
Ultra Simple Campaign Dashboard - No Pandas Required!
...
def install_requirements():
    ...
    try:
        subprocess.check_call([sys.executable, '-m', 'pip', 'install', '-r', 'no_pandas_requirements.txt'])
...
def start_dashboard():
    ...
    try:
        subprocess.run([sys.executable, 'no_pandas_app.py'])
